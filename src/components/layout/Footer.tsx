    ...
    <footer className="w-full bg-brand-maroon text-white pt-16 pb-8 px-6">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-xs text-white/70 leading-relaxed mb-6">
              Elevating modest fashion with premium fabrics, elegant designs, and unparalleled craftsmanship. Designed for the modern modest woman.
            </p>
          ...
          <div>
            <h4 className="text-[11px] font-bold tracking-widest uppercase mb-6 text-brand-gold">Shop</h4>
            <ul className="space-y-4 text-xs text-white/70">
              ...
              <li><Link href="/collections/shalwar-kameez" className="hover:text-white transition-colors">Shalwar Kameez</Link></li>
              <li><Link href="/collections/coord-sets" className="hover:text-white transition-colors">Coord Sets</Link></li>
              <li><Link href="/collections/sale" className="hover:text-white transition-colors text-brand-gold">Sale</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-[11px] font-bold tracking-widest uppercase mb-6 text-brand-gold">Help & Info</h4>
            <ul className="space-y-4 text-xs text-white/70">
          ...
          <div>
            <h4 className="text-[11px] font-bold tracking-widest uppercase mb-6 text-brand-gold">Contact</h4>
            <ul className="space-y-4 text-xs text-white/70">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-white/50">
          <p>© 2026 Modest Fashion Store. All rights reserved.</p>
          <div className="flex gap-4">
