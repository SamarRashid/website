...
export default function LoginPage() {
  return (
    <div className="w-full min-h-screen bg-brand-bg flex items-center justify-center p-6">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col relative border border-black/5">
        ...
        <div className="bg-brand-maroon text-white p-8 pb-6 relative">
          ...
          <p className="text-[11px] text-white/80 tracking-wide">Sign in to your account</p>
        </div>
        ...
        <div className="p-8 pt-6 bg-[#FEFDF9]">
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full bg-[#F5EFE6] border border-black/5 rounded-md px-4 py-3 text-sm focus:outline-none focus:border-brand-maroon transition-colors" />
            </div>

            <div className="flex justify-end pt-1">
              <Link href="#" className="text-[9px] font-bold text-brand-gold hover:underline">Forgot password?</Link>
            </div>
          ...
          <div className="mt-6 text-center text-[10px] text-brand-text-light">
            New here? <Link href="/signup" className="font-bold text-brand-maroon hover:underline">Create account</Link>
          </div>
